    ...
    <div class="flex flex-row items-center justify-center bg-[#0E1111]">
      <div class="w-[70%] flex justify-center">
        <ul class="flex flex-row py-2">
          ...
          <li class="px-4 py-2 hover:cursor-default hover:text-violet" @click="$router.push('/blog')">
            Blog
          </li>
          <li class="px-4 py-2 hover:cursor-default hover:text-violet" @click="$router.push('/project')">
            Project
          </li>
          <li class="px-4 py-2 hover:cursor-default hover:text-violet" @click="$router.push('/about')">
            About
          </li>
        </ul>
      </div>
