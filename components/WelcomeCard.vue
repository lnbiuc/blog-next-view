    ...
    <div
      ...
      <div
        ...
        <img src="/favicon.ico" alt="logo"
          class="rounded-full shadow-md h-[200px] w-[200px] sm:h-[200px] md:h-[250px] xl:h-[250px] lg:h-[250px] sm:w-[200px] md:w-[250px] xl:w-[250px] lg:w-[250px] transition-all hover:shadow-xl animated animated-rotate-in">
      </div>
    </div>
  </NuxtLayout>
</template>
