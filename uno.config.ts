...
export default defineConfig({
  shortcuts: [
    ...
    ['card-border', 'rounded hover:cursor-default border border-gray-300 hover:border-violet dark:hover:border-violet shadow-sm dark:border-gray-600 focus:outline-none focus-visible:ring focus-visible:ring-primary-300 scale-100 hover:cursor-default active:scale-[0.97] motion-safe:transform-gpu motion-reduce:hover:scale-100 motion-reduce:hover:brightness-90 transition duration-150 animate-shadow'],
