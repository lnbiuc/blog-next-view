...
const mdHeadingId = (_text: any, _level: any, index: number) =>
    `heading-${index}`
</script>
    ...
    <div>
        ...
        <Head>
            ...
            <Meta property="og:title"
                  :content="article?.title || 'Violet\'s Blog'" />
            <Meta property="og:description"
                  :content="article?.description || 'A blog for sharing knowledge test'" />
            <Meta property="og:image"
                  :content="article?.cover[0] || 'https://vio.vin/favicon.ico'" />
            ...
            <NuxtLayout name="home">
                ...
                <div class="text-left lg:grid lg:grid-cols-[auto,250px] lg:gap-8">
                    ...
                    <div class="catalog relative">
                        <ClientOnly>
                            <MdCatalog :md-heading-id="mdHeadingId"
                                       :editor-id="id"
                                       :scroll-element-offset-top="20"
                                       :scroll-element="scrollElement"
                                       class="max-h-[100vh]" />
                        </ClientOnly>
                    </div>
                </div>
                <MyGiscus class="mt-4 py-4"
